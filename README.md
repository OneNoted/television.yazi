...
- Bootstraps its own television channel for `zoxide` mode
...
- `plugin television -- zoxide` writes its own `Yazi Zoxide` television channel under `${XDG_CONFIG_HOME:-~/.config}/television/cable/` before launching `tv`.
